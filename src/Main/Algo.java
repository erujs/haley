...
//            System.out.print("Haley");
    ...
    /*public TextArea reply(String say){
        ...
        /*
            ...
            ta_convo.append("Haley: I'm Haley, your personal lifehacks adviser. Want to learn about lifehacks?\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/blank.png"));
            lbl_screen.setIcon(img1);
        }  else if(haley.contains("no")||haley.contains("i dont like")||haley.contains("i don't like")||haley.contains("i do not like")){
            ta_convo.append("Haley: Life hacks can be a great help on your daily living. I'm sure you want to know atleast one\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/blank.png"));
            lbl_screen.setIcon(img1);
            ...
            ta_convo.append("Haley: I am already 23 meaning I am able to tell you some lifehacks. Wanana give it a try?\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/blank.png"));
            lbl_screen.setIcon(img1);
        }else if(haley.contains("bye")|| haley.contains("goodbye")){
            ta_convo.append("Haley: Awww, I will miss you..See yah!\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/blank.png"));
            lbl_screen.setIcon(img1);
            ...
            ta_convo.append("Haley: Well try these, you wont regret it :)\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/pic (9).jpg"));
            lbl_screen.setIcon(img1);
        }else if(haley.contains("wallet")){
            ta_convo.append("Haley: This, give it a try :)\n");
            ...
            ta_convo.append("Haley: Here. Dont have a second thought to do this :)\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/pic (11).jpg"));
            lbl_screen.setIcon(img1);
        }else if(haley.contains("soap")){
            ta_convo.append("Haley: I really think this will help you a lot :)\n");
            ...
            ta_convo.append("Haley: Dont have a second thought to do this :)\n");
            ...
            ta_convo.append("Haley: Shut up, dont be rude, Stop saying those words \n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/blank.png"));
            lbl_screen.setIcon(img1);
        }
        else if(haley.contains("hi") || haley.contains("hello")|| haley.contains("greetings")|| haley.contains("hey")){
            ta_convo.append("Haley: Hey\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/blank.png"));
            lbl_screen.setIcon(img1);
        }else if(haley.contains("ok")){
            ta_convo.append("Haley: Okay :)\n");
            ImageIcon img1 = new ImageIcon(Main.class.getResource("/pics/blank.png"));
            lbl_screen.setIcon(img1);
        }
